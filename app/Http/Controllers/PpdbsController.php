...
class PpdbsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $ppdb = new ppdb();
         ...
         return redirect()->route('ppdb.index')->with('success', 'Data Anda Sudah Tersimpan!');
    }
    ...
    public function update(Request $request, $id)
    {
        $ppdb = ppdb::findOrFail($id);
         ...
         return redirect()->route('ppdb.index')->with('success', 'Data Anda Sudah Diperbaharui!');
    }
    ...
    public function destroy($id)
    {
        $ppdb = ppdb::findOrFail($id);
        $ppdb->delete();
        return redirect()->route('ppdb.index')->with('success', 'Data Anda Sudah Dihapus!');
    }
}
