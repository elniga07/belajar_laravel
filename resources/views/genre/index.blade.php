    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header"><h2>{{ __('Data Genre') }}</h2></div>
                ...
                <div class="card-body">
                    ...
                    <thead>
                      ...
                      <tbody>
                         ...
                         <tr>
                           ...
                           <td>{{$data->genre}}</td>
                           <td>
                            <a class="btn btn-success" href="{{ route('genre.edit', $data->id)}}">Edit</a>
                            <a class="btn btn-warning" href="{{ route('genre.show', $data->id)}}">Show</a>
                    ...
                    <a class="btn btn-primary" href="{{ route('genre.create') }}"><b>+</b></a>
