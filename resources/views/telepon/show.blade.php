...
<div class="container">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="nama" value="{{$telepon->nomor}}" disabled>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">ID Pengguna</label>
    <input type="text" class="form-control" id="nama" value="{{$telepon->id_pengguna}}" disabled>
  </div>
<br>
    <a type="submit" class="btn btn-primary" href="{{ route('telepon.index')}}">Back</a>
</form>
                </div>
            </div>
        </div>
